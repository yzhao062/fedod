...
# def train():
    ...
    # for i, mat_file in enumerate(files[0:10]):     
    # for i, mat_file in enumerate(files[10:20]):     
    for i, mat_file in enumerate(files[25:30]):     
    # for i, mat_file in enumerate(files[30:]):     
        mat_file = mat_file[0]
    # mat_file = '1_ALOI'
    ...
    # mat_file = '39_wine'
        ...
        #     all_y.extend(batch[2].numpy().ravel().tolist())
...
#%%            
        ...
        for e in range(epochs):
            ...
            print(e, 'pred train roc {}, ap {}'.format(best_train, best_train_ap))
            print('ground train roc', train_ground_roc)
            print()
        ...
        plt.plot(x_range, train_rocs, label='train', c='red')
        plt.hlines(train_ground_roc, xmin=0, xmax=epochs, label='train by tree', linestyle='--', color='red')
