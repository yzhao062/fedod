...
# def train():
    ...
    for n in range(n_estimators):
        ...
        roc_list.append(roc_auc_score(y_test, average(predict_test.T)))
        ap_list.append(average_precision_score(y_test, average(predict_test.T)))
        
        real_roc_list.append(roc_auc_score(y_test, average(actual_test.T)))
        real_ap_list.append(average_precision_score(y_test, average(actual_test.T)))
        

#%%

print('avg perf', np.mean(roc_list))
print('avg real', np.mean(real_roc_list))

print('avg ap', np.mean(ap_list))
print('avg real', np.mean(real_ap_list))
