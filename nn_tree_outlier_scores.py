...
plt.plot(x_range, test_rocs, label='test')
...
# plt.plot(x_range, train_rocs, label='train')
plt.plot(x_range, valid_aps, label='valid')
plt.plot(x_range, test_aps, label='test')
plt.hlines(test_ap_iforest, xmin=0, xmax=epochs, label='test by tree', linestyle='--', color='red')

plt.xlabel("number of epochs", size=12)
plt.ylabel("ap", size=15)
plt.title(mat_file)
